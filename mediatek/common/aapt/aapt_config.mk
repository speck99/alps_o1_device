...
ifeq (,$(strip $($eval $(PRODUCT_AAPT_PREF_CONFIG))))
  ifeq ($(LCM_HEIGHT)_$(LCM_WIDTH),320_240)
    ...
    PRODUCT_AAPT_PREF_CONFIG := xhdpi
# Vanzo:zhangqingzhan on: Thu, 01 Mar 2018 15:50:01 +0800
# for new height and width use xhdpi
  else ifeq ($(LCM_HEIGHT)_$(LCM_WIDTH),1440_720)
    PRODUCT_AAPT_PREF_CONFIG := xhdpi
  else ifeq ($(LCM_HEIGHT)_$(LCM_WIDTH),1512_720)
    PRODUCT_AAPT_PREF_CONFIG := xhdpi
