...
# Vanzo:hanshengpeng on: Fri, 22 Dec 2017 15:57:48 +0800
# by wma macro
#PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_mediatek_audio_phone.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
        ifeq ($(MTK_WMA_PLAYBACK_SUPPORT),yes)
            PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_mediatek_audio_phone.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
        else
            PRODUCT_COPY_FILES += device/mediatek/mt6739/media_codecs_mediatek_audio_phone_del_wma.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_mediatek_audio.xml:mtk
        endif
...
#PRODUCT_COPY_FILES += device/mediatek/mt6739/mtk_omx_core_gmo.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
  ifeq ($(MTK_WMA_PLAYBACK_SUPPORT),yes)
    ...
    PRODUCT_COPY_FILES += device/mediatek/mt6739/mtk_omx_core_gmo_del_wma.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
  endif
# End of Vanzo:hanshengpeng
else
...
#PRODUCT_COPY_FILES += device/mediatek/mt6739/mtk_omx_core.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
  ifeq ($(MTK_WMA_PLAYBACK_SUPPORT),yes)
    ...
    PRODUCT_COPY_FILES += device/mediatek/mt6739/mtk_omx_core_del_wma.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/mtk_omx_core.cfg:mtk
  endif
# End of Vanzo:hanshengpeng
endif
...
ifeq ($(strip $(VANZO_GF3258_32BIT_FINGERPRINT)), yes) 
    ...
    PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/goodix/libs/arm32-gf3258/goodixfingerprintd:vendor/bin/goodixfingerprintd
...
# copy msensor lib vanzo
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/memsicd5603x/libmemsicd5603x.so:system/lib/libmemsicd5603x.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/memsicd5603xnew/libmemsicd5603xnew.so:system/lib/libmemsicd5603xnew.so
ifeq ($(strip $(VANZO_MAGNETOMETER_QMCX983)), yes)
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/qmcX983/libcalmodule_qmcX983.so:system/lib/libcalmodule_qmcX983.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/qmcX983/lib64/libcalmodule_qmcX983.so:system/lib64/libcalmodule_qmcX983.so
endif
ifeq ($(strip $(VANZO_FINGERPRINT_USE_FPC)), yes)
#$(call inherit-product-if-exists, vanzo/fingerprints/device/device.mk)
PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_tee/fda3c56b-c277-4b18-d025db6aada9e055.ta:vendor/app/t6/fda3c56b-c277-4b18-d025db6aada9e055.ta
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_tee/06bf3e2d-6be3-a45b-05d4c67c7e8afb1f.ta:vendor/app/t6/06bf3e2d-6be3-a45b-05d4c67c7e8afb1f.ta
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_tee/com.fingerprints.extension@1.0.so:system/lib/com.fingerprints.extension@1.0.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_tee/com.fingerprints.extension@1.0.so:vendor/lib/com.fingerprints.extension@1.0.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_tee/android.hardware.biometrics.fingerprint@2.1-service:vendor/bin/hw/android.hardware.biometrics.fingerprint@2.1-service
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_tee/android.hardware.biometrics.fingerprint@2.1-service.rc:vendor/etc/init/android.hardware.biometrics.fingerprint@2.1-service.rc
endif
ifeq ($(strip $(VANZO_FINGERPRINT_USE_FPC_REE)), yes)
#$(call inherit-product-if-exists, vanzo/fingerprints/device/device.mk)
PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_ree/com.fingerprints.extension@1.0.so:system/lib/com.fingerprints.extension@1.0.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_ree/lib_fpc_ta_shared.so:system/lib/lib_fpc_ta_shared.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_ree/android.hardware.biometrics.fingerprint@2.1-service:vendor/bin/hw/android.hardware.biometrics.fingerprint@2.1-service
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/fpc_ree/android.hardware.biometrics.fingerprint@2.1-service.rc:vendor/etc/init/android.hardware.biometrics.fingerprint@2.1-service.rc
endif

ifeq ($(strip $(VANZO_FINGERPRINT_USE_MICROARRAY)), yes)
#$(call inherit-product-if-exists, vanzo/fpc_fingerprints/device/device.mk)
PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
#add by microarray
...
ifeq ($(strip $(VANZO_FINGERPRINT_MICROARRAY_E064N_REE)), yes)
#$(call inherit-product-if-exists, vanzo/fpc_fingerprints/device/device.mk)
PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
#add by microarray
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-etservice
...
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service
PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_e064n/fingerprint.default.so:system/lib/hw/fingerprint.default.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_e064n/libfprint-x32.so:system/lib/libfprint-x32.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_e064n/libma-fpservice.so:system/lib/libma-fpservice.so
endif

ifeq ($(strip $(VANZO_FINGERPRINT_USE_MICROARRAY_TEE)), yes)
#$(call inherit-product-if-exists, vanzo/fpc_fingerprints/device/device.mk)
PRODUCT_COPY_FILES += $(call add-to-product-copy-files-if-exists,frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml)
#add by microarray
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-etservice
...
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service
PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_116n_tee/edcf9395-3518-9067-614cafae2909775b.ta:vendor/app/t6/edcf9395-3518-9067-614cafae2909775b.ta
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_116n_tee/fingerprint.default.so:system/lib/hw/fingerprint.default.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_116n_tee/libfprint-x32.so:system/lib/libfprint-x32.so
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/microarray_32_116n_tee/libma-fpservice.so:system/lib/libma-fpservice.so
endif

ifeq ($(strip $(VANZO_FINGERPRINT_USE_BETTERLIFE_FP)), yes)
# Fingerprint add blestech start
PRODUCT_PACKAGES += \
...
PRODUCT_COPY_FILES +=vendor/mediatek/proprietary/external/betterlife_fp/f74c8d0d-4284-4acf-d0c425260610b3bd.ta:vendor/app/t6/f74c8d0d-4284-4acf-d0c425260610b3bd.ta
PRODUCT_COPY_FILES += \
    vendor/mediatek/proprietary/external/betterlife_fp/fingerprint.default.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/fingerprint.default.so \
    vendor/mediatek/proprietary/external/betterlife_fp/libBtlFpHal.so:$(TARGET_COPY_OUT_VENDOR)/lib/libBtlFpHal.so \
    vendor/mediatek/proprietary/external/betterlife_fp/libxuFPAlg.so:$(TARGET_COPY_OUT_VENDOR)/lib/libxuFPAlg.so \
    vendor/mediatek/proprietary/external/betterlife_fp/libBtlFpJni.so:$(TARGET_COPY_OUT_VENDOR)/lib/libBtlFpJni.so

# Fingerprint add blestech end
endif

#add by sunwave_fp for finger start
ifeq ($(strip $(VANZO_FINGERPRINT_SUNWAVE_REE_FP)),yes)
#android .so
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-etservice
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1
PRODUCT_PACKAGES += android.hardware.biometrics.fingerprint@2.1-service
PRODUCT_COPY_FILES += frameworks/native/data/etc/android.hardware.fingerprint.xml:system/etc/permissions/android.hardware.fingerprint.xml
# sunwave fpserver
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/bin/fpserver:vendor/bin/fpserver

# sunwave 32bits libs
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib/libfpClient_sw.so:vendor/lib/libfpClient_sw.so
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib/libfpService_sw.so:vendor/lib/libfpService_sw.so
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib/vendor.sw.swfingerprint@1.0.so:vendor/lib/vendor.sw.swfingerprint@1.0.so
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib/hw/sw_sensor.default.so:vendor/lib/hw/sw_sensor.default.so
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib/hw/sunwave.fingerprint.default.so:vendor/lib/hw/sunwave.fingerprint.default.so

# sunwave 64bits libs
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib64/libfpClient_sw.so:vendor/lib64/libfpClient_sw.so
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib64/vendor.sw.swfingerprint@1.0.so:vendor/lib64/vendor.sw.swfingerprint@1.0.so
#PRODUCT_COPY_FILES += vendor/joya_sz/sunwave_ree/lib64/hw/sw_sensor.default.so:vendor/lib64/hw/sw_sensor.default.so
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/external/sunwave_ree/lib64/hw/sunwave.fingerprint.default.so:vendor/lib64/hw/sunwave.fingerprint.default.so

endif
#add by sunwave_fp for finger end
