...
PRODUCT_NAME := full_fd368b
PRODUCT_DEVICE := fd368b
PRODUCT_MODEL := fd368b
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= fd368b_debug_defconfig
else
KERNEL_DEFCONFIG ?= fd368b_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= fd368b
LK_PROJECT ?= fd368b
TRUSTY_PROJECT ?= fd368b
