...
PRODUCT_NAME := full_nd393c
PRODUCT_DEVICE := nd393c
PRODUCT_MODEL := nd393c
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= nd393c_debug_defconfig
else
KERNEL_DEFCONFIG ?= nd393c_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= nd393c
LK_PROJECT ?= nd393c
TRUSTY_PROJECT ?= nd393c
#A-GO
