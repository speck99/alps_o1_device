...
PRODUCT_NAME := full_fd3902
PRODUCT_DEVICE := fd3902
PRODUCT_MODEL := fd3902
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= fd3902_debug_defconfig
else
KERNEL_DEFCONFIG ?= fd3902_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= fd3902
LK_PROJECT ?= fd3902
TRUSTY_PROJECT ?= fd3902
