...
PRODUCT_NAME := full_fd610b
PRODUCT_DEVICE := fd610b
PRODUCT_MODEL := fd610b
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= fd610b_debug_defconfig
else
KERNEL_DEFCONFIG ?= fd610b_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= fd610b
LK_PROJECT ?= fd610b
TRUSTY_PROJECT ?= fd610b
