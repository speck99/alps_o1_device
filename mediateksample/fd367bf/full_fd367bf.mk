...
PRODUCT_NAME := full_fd367bf
PRODUCT_DEVICE := fd367bf
PRODUCT_MODEL := fd367bf
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= fd367bf_debug_defconfig
else
KERNEL_DEFCONFIG ?= fd367bf_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= fd367bf
LK_PROJECT ?= fd367bf
TRUSTY_PROJECT ?= fd367bf
