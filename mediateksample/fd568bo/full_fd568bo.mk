...
PRODUCT_NAME := full_fd568bo
PRODUCT_DEVICE := fd568bo
PRODUCT_MODEL := fd568bo
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= fd568bo_debug_defconfig
else
KERNEL_DEFCONFIG ?= fd568bo_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= fd568bo
LK_PROJECT ?= fd568bo
TRUSTY_PROJECT ?= fd568bo
