...
PRODUCT_NAME := full_fd568b
PRODUCT_DEVICE := fd568b
PRODUCT_MODEL := fd568b
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= fd568b_debug_defconfig
else
KERNEL_DEFCONFIG ?= fd568b_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= fd568b
LK_PROJECT ?= fd568b
TRUSTY_PROJECT ?= fd568b
