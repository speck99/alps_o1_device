...
PRODUCT_NAME := full_nd359b
PRODUCT_DEVICE := nd359b
PRODUCT_MODEL := nd359b
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= nd359b_debug_defconfig
else
KERNEL_DEFCONFIG ?= nd359b_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= nd359b
LK_PROJECT ?= nd359b
TRUSTY_PROJECT ?= nd359b
#A-GO
